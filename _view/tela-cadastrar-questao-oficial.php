...
<body style="background-color:#606c76">
	...
	<div id="botoes" style="margin-top:-20px" class="container-fluid card">			  
	...
	<div  id="cadProva" style="margin-top:-20px" class="container-fluid card">			  
	 	<div style="margin-top:10px" class="row">  
			<div class="col-sm-0 col-md-3 col-lg-7">
	...
	<div id="cadQuestao" style="margin-top:-20px" class="container-fluid card">			  
	 	<div style="margin-top:10px" class="row">           
